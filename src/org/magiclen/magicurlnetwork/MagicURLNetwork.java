...
public abstract class MagicURLNetwork {
     ...
     * 換行字元。
     */
    protected static final byte[] LINE_CHARACTER = new byte[]{10};
	 ...
	 * 模擬火狐瀏覽器。
	 */
	public static final String FIREFOX = "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:43.0) Gecko/20100101 Firefox/43.0";
	/**
	 * 模擬Google的Chrome瀏覽器。
	 */
	public static final String CHROME = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36";
	/**
	 * 模擬Android的WebKit。
	 */
	public static final String ANDROID = "Mozilla/5.0 (Linux; Android 6.0.1; Nexus 7 Build/MMB29K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.83 Safari/537.36";
	/**
	 * 模擬微軟的IE瀏覽器。
	 */
	public static final String INTERNET_BROWSER = "Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko";
	...
	try {
		...
		try {
		    listener.onFinished(headersObj, result);
		} catch (final Exception ex) {
		    ex.printStackTrace(System.out);
		}
	    }
